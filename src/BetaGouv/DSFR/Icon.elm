...
allIcons : List IconName
allIcons =
    [ accountFill, accountLine, addCircleFill, addCircleLine, addLine, arrowDownLine, arrowDownSLine, arrowGoBackFill, arrowGoBackLine, arrowLeftLine, arrowLeftSFirstLine, arrowLeftSLine, arrowLeftSLineDouble, arrowRightLine, arrowRightSLastLine, arrowRightSLine, arrowRightSLineDouble, arrowRightUpLine, arrowUpFill, arrowUpLine, arrowUpSLine, attachmentFill, attachmentLine, bold, calendarFill, calendarLine, chatQuoteFill, chatQuoteLine, checkLine, closeLine, dailymotionFill, dailymotionLine, deleteFill, deleteLine, downloadLine, editFill, editLine, equalizerFill, equalizerLine, errorFill, errorLine, errorWarningFill, errorWarningLine, externalLinkLine, eyeFill, eyeLine, eyeOffFill, eyeOffLine, facebookCircleFill, facebookCircleLine, fileDownloadFill, fileDownloadLine, fileFill, fileLine, filePdfFill, filePdfLine, filterFill, filterLine, flashlightFill, flashlightLine, fontSize, githubFill, githubLine, highlight, home4Fill, home4Line, imageFill, imageLine, infoFill, infoLine, informationFill, informationLine, instagramFill, instagramLine, italic, lineChartFill, lineChartLine, linkUnlink, linkedinBoxFill, linkedinBoxLine, linksFill, listOrdered, listUnordered, lockFill, lockLine, logoutBoxRFill, logoutBoxRLine, mailFill, mailLine, mapPin2Fill, mapPin2Line, menu2Fill, menuFill, npmjsFill, npmjsLine, pauseCircleFill, pauseCircleLine, phoneFill, phoneLine, playFill, playLine, printerFill, printerLine, questionFill, questionLine, refreshFill, refreshLine, remixiconFill, remixiconLine, roadMapFill, roadMapLine, rssFill, rssLine, saveFill, saveLine, searchFill, searchLine, slackFill, slackLine, snapchatFill, snapchatLine, subtractLine, successFill, successLine, telegramFill, telegramLine, themeFill, tiktokFill, tiktokLine, twitchFill, twitchLine, twitterFill, twitterLine, upload2Fill, upload2Line, userFill, userLine, vimeoFill, vimeoLine, volumeDownFill, volumeDownLine, volumeMuteFill, volumeMuteLine, volumeUpFill, volumeUpLine, warningFill, warningLine, youtubeFill, youtubeLine, zoomInFill, zoomInLine, zoomOutFill, zoomOutLine ]
